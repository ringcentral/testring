...
//
//
// const asyncPluginPath = path.resolve(__dirname, './fixtures/on-action-async.ts');
// const pluginPath = path.resolve(__dirname, './fixtures/on-action.ts');
// const pluginConfig = {};
// const commandMock = {
